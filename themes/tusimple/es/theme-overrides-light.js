...
export const themeOverridesLight = {
    common: Object.assign({ fontSize: '16px', fontSizeMedium: '16px', fontWeightStrong: '700', borderRadius: '16px', boxShadow2: vars.NORMAL_BOX_SHADOW, borderColor: '#999', dividerColor: '#EBEDF0', tableHeaderColor: '#EBEDF0', inputColorDisabled: '#EBEDF0', actionColor: '#EBEDF0', hoverColor: changeColor(colors.primaryColor, { alpha: 0.1 }), clearColor: composite('#FFF', 'rgba(0, 0, 0, .4)') }, colors),
    Avatar: {
        borderRadius: '50%'
    },
    BackTop: {
    ...
    DataTable: {
        ...
        tdColorHover: composite(commonLight.primaryColor, 'rgba(255, 255, 255, .9)'),
        thButtonColorHover: '#0000',
        thColorModal: '#EBEDF0',
        tdColorHoverModal: composite(commonLight.primaryColor, 'rgba(255, 255, 255, .9)'),
    ...
    Pagination: {
        ...
        itemColor: '#0000',
        itemColorPressed: composite(commonLight.primaryColor, 'rgba(255, 255, 255, 0.9)'),
        itemColorHover: composite(commonLight.primaryColor, 'rgba(255, 255, 255, 0.9)'),
        itemColorActiveHover: composite(commonLight.primaryColor, 'rgba(255, 255, 255, 0.9)'),
