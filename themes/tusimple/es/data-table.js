...
export const renderSorter = ({ order }) => {
    const chevronStyle = {
        height: '16px',
        width: '16px',
        marginBottom: '-4px',
    ...
    return h('div', {
        ...
        h(CaretUpOutline, {
            style: Object.assign(Object.assign({}, chevronStyle), { marginTop: '-4px', color: order === 'ascend' ? colors.successColor : GRAY_COLOR_4 })
        }),
        h(CaretDownOutline, {
            style: Object.assign(Object.assign({}, chevronStyle), { color: order === 'descend' ? colors.successColor : GRAY_COLOR_4 })
        })
    ]);
};
export const renderFilter = ({ active, show }) => {
